...
// tests for TransactionSignatureMultiAgentSignature
void main() {
  final instance = TransactionSignatureMultiAgentSignatureBuilder();
  // TODO add properties to the builder and call build()

  group(TransactionSignatureMultiAgentSignature, () {
    // String type
