...
void main() {
  ...
  group(EventsApi, () {
    ...
    //
    //Future<BuiltList<Event>> getEventsByEventHandle(String address, String eventHandleStruct, String fieldName, { int start, int limit }) async
    ...
    //
    //Future<BuiltList<Event>> getEventsByEventKey(String eventKey) async
