...
class TransactionsApi {
  ...
  Future<Response<String>> encodeSubmission({
    required EncodeSubmissionRequest encodeSubmissionRequest,
    ...
    final _path = r'/transactions/encode_submission';
    ...
    try {
      const _type = FullType(EncodeSubmissionRequest);
      _bodyData =
          _serializers.serialize(encodeSubmissionRequest, specifiedType: _type);
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [GasEstimation] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<GasEstimation>> estimateGasPrice({
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/estimate_gas_price';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Throws [DioError] if API call or serialization fails
  Future<Response<BuiltList<Transaction>>> getAccountTransactions({
  ...
  /// Throws [DioError] if API call or serialization fails
  Future<Response<Transaction>> getTransactionByHash({
    ...
    final _path = r'/transactions/by_hash/{txn_hash}'
        .replaceAll('{' r'txn_hash' '}', txnHash.toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Returns a [Future] containing a [Response] with a [Transaction] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<Transaction>> getTransactionByVersion({
    required String txnVersion,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/transactions/by_version/{txn_version}'
        .replaceAll('{' r'txn_version' '}', txnVersion.toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Returns a [Future] containing a [Response] with a [BuiltList<Transaction>] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<BuiltList<Transaction>>> getTransactions({
    String? start,
    int? limit,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [BuiltList<UserTransaction>] as data
  /// Throws [DioError] if API call or serialization fails
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [TransactionsBatchSubmissionResult] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<TransactionsBatchSubmissionResult>> submitBatchTransactions({
    required BuiltList<SubmitTransactionRequest> submitTransactionRequest,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/transactions/batch';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    try {
      const _type = FullType(BuiltList, [FullType(SubmitTransactionRequest)]);
      _bodyData = _serializers.serialize(submitTransactionRequest,
          specifiedType: _type);
    } catch (error, stackTrace) {
      throw DioError(
    ...
    return Response<TransactionsBatchSubmissionResult>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
